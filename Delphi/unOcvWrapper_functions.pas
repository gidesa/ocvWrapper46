...
Function   pCvSubdiv2DgetVertex(const wrapper: PCvSubdiv2D_t; vertex: Integer; 
                 firstEdge: PInteger { default: 0 } = nil): PCvPoint2f_t; cdecl;
...
Function   pCvcheckRange(a: PCvMat_t; quiet: Boolean { default: true } = true; 
                 _pos: PCvPoint_t { default: 0 } = nil; minVal: Double { default: -DBL_MAX } = -MAXDOUBLE; 
...
Function   pCvfloodFill(image: PCvMat_t; mask: PCvMat_t; seedPoint: PCvPoint_t; newVal: PCvScalar_t; 
                 rect: PCvRect_t { default: 0 } = nil; loDiff: PCvScalar_t { default: Scalar() } = nil; 
...
Function   pCvgetOptimalNewCameraMatrix(cameraMatrix: PCvMat_t; distCoeffs: PCvMat_t; 
                 ...
                 validPixROI: PCvRect_t { default: 0 } = nil; centerPrincipalPoint: Boolean { default: false } = false): PCvMat_t; cdecl;
Function   pCvgetOptimalNewCameraMatrixV2(cameraMatrix: PCvUMat_t; distCoeffs: PCvUMat_t; 
                 imageSize: PCvSize_t; alpha: Double; 
                 newImgSize: PCvSize_t { default: Size() } = nil; validPixROI: PCvRect_t { default: 0 } = nil; 
...
Procedure  pCvminMaxLoc(src: PCvMat_t; minVal: PDouble; maxVal: PDouble { default: 0 } = nil; 
                 minLoc: PCvPoint_t { default: 0 } = nil; maxLoc: PCvPoint_t { default: 0 } = nil; 
                 mask: PCvMat_t { default: Mat() } = nil); cdecl;
Procedure  pCvminMaxLocV2(src: PCvUMat_t; minVal: PDouble; maxVal: PDouble { default: 0 } = nil; 
                 minLoc: PCvPoint_t { default: 0 } = nil; maxLoc: PCvPoint_t { default: 0 } = nil; 
                 mask: PCvUMat_t { default: UMat() } = nil); cdecl;
...
Function   pCvphaseCorrelate(src1: PCvMat_t; src2: PCvMat_t; window: PCvMat_t { default: Mat() } = nil; 
                 response: PDouble { default: 0 } = nil): PCvPoint2d_t; cdecl;
Function   pCvphaseCorrelateV2(src1: PCvUMat_t; src2: PCvUMat_t; 
                 window: PCvUMat_t { default: UMat() } = nil; response: PDouble { default: 0 } = nil): PCvPoint2d_t; cdecl;
...
Procedure  pCvrandShuffle(dst: PCvMat_t; iterFactor: Double { default: 1. } = 1.0; 
                 rng: PCvRNG_t { default: 0 } = nil); cdecl;
...
Procedure  pCvstereoRectify(cameraMatrix1: PCvMat_t; distCoeffs1: PCvMat_t; cameraMatrix2: PCvMat_t; 
                 ...
                 newImageSize: PCvSize_t { default: Size() } = nil; validPixROI1: PCvRect_t { default: 0 } = nil; 
                 validPixROI2: PCvRect_t { default: 0 } = nil); cdecl;
