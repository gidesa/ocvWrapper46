...
implementation
 ...
 function   pCvStringCreate;              external ocvWrapper  name 'pCvStringCreate'  delayed;
 procedure  pCvStringDelete;              external ocvWrapper  name 'pCvStringDelete'  delayed;

 function   pCvMatCreate;                 external ocvWrapper  name 'pCvMatCreate'  delayed;
 function   pCvMat2dCreate;               external ocvWrapper  name 'pCvMat2dCreate'  delayed;
 function   pCvMatCreateEmpty;            external ocvWrapper  name 'pCvMatCreateEmpty'  delayed;
 function   pCvMatImageCreate;            external ocvWrapper  name 'pCvMatImageCreate'  delayed;
 procedure  pCvMatDelete;                 external ocvWrapper  name 'pCvMatDelete'  delayed;
 function   pCvMatROI;                    external ocvWrapper  name 'pCvMatROI'  delayed;
 procedure  pCvMatCopy;                   external ocvWrapper  name 'pCvMatCopy'  delayed;
 procedure  pCvMatConvertTo;              external ocvWrapper  name 'pCvMatConvertTo'  delayed;
 procedure  pCvMatExtractChannel;         external ocvWrapper  name 'pCvMatExtractChannel'  delayed;
 function   pCvMatClone;                  external ocvWrapper  name 'pCvMatClone'  delayed;
 procedure  pCvMatCopyToUmat;             external ocvWrapper  name 'pCvMatCopyToUmat'  delayed;
 function   pCvMatToUmat;                 external ocvWrapper  name 'pCvMatToUmat'  delayed;
 function   pCvMatFromUmat;               external ocvWrapper  name 'pCvMatFromUmat'  delayed;
 procedure  pCvMatFill;                   external ocvWrapper  name 'pCvMatFill'  delayed;
 procedure  pCvMatScalarOp;               external ocvWrapper  name 'pCvMatScalarOp'  delayed;
 function   pCvMatGetByte;                external ocvWrapper  name 'pCvMatGetByte'  delayed;
 function   pCvMatSetByte;                external ocvWrapper  name 'pCvMatSetByte'  delayed;
 function   pCvMatGetInt;                 external ocvWrapper  name 'pCvMatGetInt'  delayed;
 function   pCvMatSetInt;                 external ocvWrapper  name 'pCvMatSetInt'  delayed;
 function   pCvMatGetFloat;               external ocvWrapper  name 'pCvMatGetFloat'  delayed;
 function   pCvMatSetFloat;               external ocvWrapper  name 'pCvMatSetFloat'  delayed;
 function   pCvMatGetFloatMultidim;       external ocvWrapper  name 'pCvMatGetFloatMultidim'  delayed;
 function   pCvMatSetFloatMultidim;       external ocvWrapper  name 'pCvMatSetFloatMultidim'  delayed;
 function   pCvMatGetDouble;              external ocvWrapper  name 'pCvMatGetDouble'  delayed;
 function   pCvMatSetDouble;              external ocvWrapper  name 'pCvMatSetDouble'  delayed;
 function   pCvMatGetPixelC3;             external ocvWrapper  name 'pCvMatGetPixelC3'  delayed;
 function   pCvMatSetPixelC3;             external ocvWrapper  name 'pCvMatSetPixelC3'  delayed;
 function   pCvMatGetWidth;               external ocvWrapper  name 'pCvMatGetWidth'  delayed;
 function   pCvMatGetHeight;              external ocvWrapper  name 'pCvMatGetHeight'  delayed;
 function   pCvMatGetChannels;            external ocvWrapper  name 'pCvMatGetChannels'  delayed;
 function   pCvMatGetType;                external ocvWrapper  name 'pCvMatGetType'  delayed;
 function   pCvMatGetDimsNum;             external ocvWrapper  name 'pCvMatGetDimsNum'  delayed;
 procedure  pCvMatGetDims;                external ocvWrapper  name 'pCvMatGetDims'  delayed;
 function   pCvMatGetDimPtr;              external ocvWrapper  name 'pCvMatGetDimPtr'  delayed;
 function   pCvMatGetData;                external ocvWrapper  name 'pCvMatGetData'  delayed;
 function   pCvMatGetDepth;               external ocvWrapper  name 'pCvMatGetDepth'  delayed;
 procedure  pCvIplImageToMat;             external ocvWrapper  name 'pCvIplImageToMat'  delayed;
 function   pCvMatToIplImage;             external ocvWrapper  name 'pCvMatToIplimage'  delayed;
 procedure  pCvIplImageDelete;            external ocvWrapper  name 'pCvIplImageDelete'  delayed;
