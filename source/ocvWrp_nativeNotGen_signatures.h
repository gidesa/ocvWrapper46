...
unsigned char     pCvMatGetByte(struct Mat_t* wrapper, int rowind, int colind); 
unsigned char     pCvMatSetByte(struct Mat_t* wrapper, int rowind, int colind, unsigned char value);
